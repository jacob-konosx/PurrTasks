...
// REVIEW: returns any, either should specify type or nothing at all and let it be inferred
const verifyUser = async (token: String): Promise<any> => {
  ...
  if (!res.ok) {
	// REVIEW: you should not show toast here, you should do it in the mutate onError, this function should only be responsible for data fetching
...
const page: NextPage = (): JSX.Element => {
  ...
  // REVIEW: unnecessary spaces in className
  return (
